  ...
  ({ className, children, ...props }, ref) => (
    <DrawerPortal>
      ...
      <DrawerPrimitive.Content
        ref={ref}
        className={cn("fixed inset-x-0 bottom-0 z-50 mt-24 flex h-auto flex-col rounded-t-[10px] border border-secondary bg-background", className)}
        {...props}
      >
        <div className="mx-auto mb-6 h-1 w-[100px] rounded-full bg-muted" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  ),
