...
const GamesCarousel = (props: GamesCarouselProps) => {
    ...
    return (
        <div className="mb-4">
            <h1 className="font-semibold text-lg pb-2 px-4">{title}</h1>
            <div className="flex items-center gap-2 carousel">
                {
                    games.map((x) => (
                        <div key={x.id} className="flex flex-col items-start justify-center carousel-item pl-4">
