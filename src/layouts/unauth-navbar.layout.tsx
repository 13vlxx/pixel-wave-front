  ...
  return (
    <>
      <header className="sticky top-0 navbar bg-base-200 flex justify-between px-10 shadow-md md:px-20 shadow-accent/30 z-10">
        <h1
          className="text-2xl font-semibold cursor-pointer bg-gradient-to-l from-accent to-secondary text-transparent bg-clip-text"
        ...
        <nav className="flex gap-4">
          ...
          <CgProfile data-cy="auth-modal" name="profile" className="text-2xl cursor-pointer" onClick={toggleModal} />
        </nav>
      </header>
      <div>
        <Outlet />
